...
import { omitEmptyValues } from './util';
...
export const fetchRows = async (sheetName) => {
  ...
  const validColumnHeadersBySheetName = {
    ...
    Fournisseurs: ['Code Fournisseur', 'Libellé'],
  };

  const expectedColumnHeaders = validColumnHeadersBySheetName[sheetName];
